    ...
    <div class="col-xl-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold" style="color: rgb(127, 29 ,29)">Upload Groups Documents</h6>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <?php $status = $group_data['7'];
                                                ...
                                                ?></td>
                                    <td>
                                        <a href="group_document.php?gp_id=<?php echo $group_data['0']  ?>"
                                            class="btn btn-primary btn-circle "><i class="fa fa-book"></i></a>
                                    </td>
                                </tr>
