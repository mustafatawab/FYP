                             ...
                             <table class="table " id="dataTable" width="100%" cellspacing="0">
                                ...
                                ?>
                                     <tr>
                                         ...
                                         <td><a href="faculty.php?del_id=<?php echo $faculty_data['0']  ?>" 
                                         class="btn btn-primary  ">Evalvator</a></td>
                     ...
                     <div class="card-body">
                         <div class="">
                             <form method="post" action="faculty.php">
                                 ...
                                 <input type="text" name="name" placeholder="Enter Username " class="form-control mb-3" 
                                 required /> 
