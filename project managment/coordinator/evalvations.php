                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-success btn-circle" data-toggle="modal" type="button"
                                            ...
                                            <a href="evalvations.php?del_id=<?php echo $evalvation_data['0']  ?>"
                                    ...
                                    <div class="modal fade"
                                        id="update_modal<?php echo $evalvation_data['evalvations_id'] ?>"
                                        aria-hidden="true">
                                                ...
                                                <form method="POST" action="evalvations.php">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" style="color: rgb(127, 29 ,29)">
                                                            <b>Update Evalvations</b></h4>
                                                    </div>
                                                    <input type="hidden" name="id"
                                                        value="<?php echo $evalvation_data['0'] ?>">
                                                    <div class="modal-body">
                                                        <div class="col-md-12">
                                                            <label for="name" class="">Evalvation :</label>
                                                            <select name="up_evalvation" id="" class='form-control'>
                                                                <option value="<?php echo $evalvation_data['1'] ?>">
                                                                    <?php echo $evalvation_data['1'] ?></option>
                                                            ...
                                                            <select name="up_semester" id="" class='form-control'>
                                                                <option value="<?php echo $evalvation_data['2'] ?>">
                                                                    <?php echo $evalvation_data['2'] ?></option>
                                                            ...
                                                            <textarea name="up_description" id="" cols="30" rows="4"
                                                                placeholder=' Enter Description' class='form-control'>
                                                <?php echo $evalvation_data['3'] ?>
                                                </textarea>
                                                            <div class='flex justify-center items-center'>
                                                                <input type="radio" id="fyp1" name="up_fyp"
                                                                    value="FYP 1">
                                                                <label for="fyp1"
                                                                    class='px-2 font-semibold text-gray-600'> FYP
                                                                    1</label>
                                                                <input type="radio" id="fyp2" name="up_fyp"
                                                                    value="FYP 2">
                                                                <label for="fyp2"
                                                                    class='px-2 font-semibold text-gray-600'> FYP
                                                                    2</label>
                    ...
                    <div class="card-body">
                        <div class="">
                            <form method="post" action="evalvations.php">
                                ...
                                <label for="date">Description :</label>
                                <textarea name="description" id="" cols="30" rows="4" placeholder=' Enter Description'
